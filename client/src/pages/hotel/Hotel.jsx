...
const Hotel = () => {
  ...
  const {data, loadig, error} = useFetch(`/hotels/find/${id}`)
        ...
        <div className="hotelWrapper">
          ...
          <div className="hotelDetails">
            <div className="hotelDetailsTexts">
              ...
              <p className="hotelDesc">Material: flour,egg, water, etc
              <br></br>
              <br></br>Capacity: Minimum 100kg/h,can be customized
              <br></br>
              <br></br>Description:
              <br></br>
              The hard & soft biscuit production line is developed by our company through 
              digestion and absorption of advanced technology, which can make different shapes of biscuits.
              <br></br>
